 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Jan 11 14:42:17 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME test_f
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define SOURCEFILES           "__SFB__contr.c"
#define PANELINDEX            8
...
extern void test_f_Outputs_wrapper(const real_T *x,
			real_T *y,
			real_T *T);
/*====================*
 * S-function methods *
